...
set(CMAKE_C_COMPILER   ${TOOLCHAIN_PREFIX}gcc${TOOLCHAIN_POSTFIX} CACHE FILEPATH "C compiler")
set(CMAKE_CXX_COMPILER ${TOOLCHAIN_PREFIX}g++${TOOLCHAIN_POSTFIX} CACHE FILEPATH "C++ compiler")
set(CMAKE_ASM_COMPILER ${TOOLCHAIN_PREFIX}gcc${TOOLCHAIN_POSTFIX} CACHE FILEPATH "ASM compiler")
set(CMAKE_AR           ${TOOLCHAIN_PREFIX}ar${TOOLCHAIN_POSTFIX} CACHE FILEPATH "Archiver")
set(CMAKE_RANLIB       ${TOOLCHAIN_PREFIX}ranlib${TOOLCHAIN_POSTFIX} CACHE FILEPATH "Ranlib")
set(CMAKE_OBJCOPY      ${TOOLCHAIN_PREFIX}objcopy${TOOLCHAIN_POSTFIX} CACHE FILEPATH "Objcopy")
set(CMAKE_SIZE         ${TOOLCHAIN_PREFIX}size${TOOLCHAIN_POSTFIX} CACHE FILEPATH "Size")
