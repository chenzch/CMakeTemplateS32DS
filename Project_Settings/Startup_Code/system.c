...
#define SetMPURegion(rbar, rasr) do { if ((rasr) & 0x1) { S32_MPU->RNR = regionNum++; S32_MPU->RBAR = (rbar); S32_MPU->RASR = (rasr); } } while (0)
    ...
    /* Size: depends on current mode (Lockstep/Decoupled Mode), Type: Normal, Inner Cache Policy: None, Outer Cache Policy: None, Shareable: No, Privileged Access:RW, Unprivileged Access:RW */
		/*rasr*/ ((MSCM_ITCM_LOCKSTEP_MODE == u32ItcmMode) ? ((uint32)0x03080001UL)|(((uint32)MPU_TCM_64KB_SIZE - 1) << 1) : ((uint32)0x03080001UL)|(((uint32)MPU_TCM_32KB_SIZE - 1) << 1))
    );

#if defined(S32K311) || defined(S32K341) || defined(S32M276) || defined(S32K310) || defined(S32M274)
    SetMPURegion(
        /*rbar*/ (uint32)__ROM_CODE_START,
        /*rasr*/ 0x070B0027UL /* Size: import information from linker symbol, Type: Normal, Inner Cache Policy: Inner write-back, write and read allocate, Outer Cache Policy: Outer write-back. write and read allocate, Shareable: No, Privileged Access: Read-Only, Unprivileged Access: Read-Only */
    );
#elif defined(S32K342) || defined(S32K312) || defined(S32K322)
	SetMPURegion(
		/*rbar*/ (uint32)__ROM_CODE_START,
        /*rasr*/ 0x070B0029UL /* Size: import information from linker symbol, Type: Normal, Inner Cache Policy: Inner write-back, write and read allocate, Outer Cache Policy: Outer write-back. write and read allocate, Shareable: No, Privileged Access: Read-Only, Unprivileged Access: Read-Only */
	);
#else
	SetMPURegion(
		/*rbar*/ (uint32)__ROM_CODE_START,
        /*rasr*/ 0x070B002BUL /* Size: import information from linker symbol, Type: Normal, Inner Cache Policy: Inner write-back, write and read allocate, Outer Cache Policy: Outer write-back. write and read allocate, Shareable: No, Privileged Access: Read-Only, Unprivileged Access: Read-Only */
	);
#endif
    ...
    SetMPURegion(
        ...
        /*rbar*/ (uint32)__ROM_DATA_START,
        /*rasr*/ 0x160B0023UL /* Size: import information from linker symbol, Type: Normal, Inner Cache Policy: Inner write-back, write and read allocate, Outer Cache Policy: Outer write-back. write and read allocate, Shareable: Yes, Privileged Access: Read-Only, Unprivileged Access: Read-Only */
    );
    ...
    SetMPURegion(
        ...
        /*rbar*/ (uint32)__INT_DTCM_START,
        /* Size: depends on current mode (Lockstep/Decoupled Mode), Type: Normal, Inner Cache Policy: None, Outer Cache Policy: None, Shareable: No, Privileged Access:RW, Unprivileged Access:RW */
        /*rasr*/ ((MSCM_DTCM_LOCKSTEP_MODE == u32DtcmMode) ? ((uint32)0x03080001UL)|(((uint32)MPU_TCM_128KB_SIZE - 1) << 1) : ((uint32)0x03080001UL)|(((uint32)MPU_TCM_64KB_SIZE - 1) << 1))
    );
    ...
    SetMPURegion(
        ...
        /*rasr*/ ((uint32)0x030B0001UL)|(((uint32)__RAM_CACHEABLE_SIZE - 1) << 1)
	);
        #endif
        #else
    ...
    SetMPURegion(
        /*rbar*/ (uint32)__INT_SRAM_START,
        /*rasr*/ ((uint32)0x030B0001UL) | (((uint32)__RAM_CACHEABLE_SIZE - 1) << 1) | (1<<15) | (1<<14)
	);
        #endif
        #else
    SetMPURegion(
    ...
    SetMPURegion(
        ...
        /*rasr*/ ((uint32)0x130C0001UL)|(((uint32)__RAM_NO_CACHEABLE_SIZE - 1) << 1)
	);
        #endif
        #else
    SetMPURegion(
        /*rbar*/ (uint32)__RAM_NO_CACHEABLE_START,
        /* Size: import information from linker symbol, Type: Normal, Inner Cache Policy: None, Outer Cache Policy: None, Shareable: Yes, Privileged Access:RW, Unprivileged Access:RW */
        /*rasr*/ ((uint32)0x130C0001UL)|(((uint32)__RAM_NO_CACHEABLE_SIZE - 1) << 1)
	);
        #endif
    ...
    SetMPURegion(
        /*rbar*/ (uint32)__RAM_SHAREABLE_START,
        /* Size: import information from linker symbol, Type: Normal, Inner Cache Policy: None, Outer Cache Policy: None, Shareable: Yes, Privileged Access:RW, Unprivileged Access:RW */
        /*rasr*/ ((uint32)0x130C0001UL)|(((uint32)__RAM_SHAREABLE_SIZE - 1) << 1)|(1<<15)|(1<<14)
	);
    ...
    SetMPURegion(
        /*rbar*/ (uint32)__RAM_SHAREABLE_START,
        /* Size: import information from linker symbol, Type: Normal, Inner Cache Policy: None, Outer Cache Policy: None, Shareable: Yes, Privileged Access:RW, Unprivileged Access:RW */
        /*rasr*/ ((uint32)0x130C0001UL)|(((uint32)__RAM_SHAREABLE_SIZE - 1) << 1)
	);
        /* Additional configuration for peripheral device*/
        #endif
    ...
    SetMPURegion(
        ...
        /* Disable subregion 7 & 8*/
        /*rasr*/ ((uint32)0x1304002DUL)|(1<<15)|(1<<14)
    );
    ...
    SetMPURegion(
        /*rbar*/ (uint32)((uint32)__ROM_CODE_START + 0x400000UL),
        /*rasr*/ 0x070B0029UL /* Size: import information from linker symbol, Type: Normal, Inner Cache Policy: Inner write-back, write and read allocate, Outer Cache Policy: Outer write-back. write and read allocate, Shareable: No, Privileged Access: Read-Only, Unprivileged Access: Read-Only */
    );
	...
	SetMPURegion(
		/*rbar*/ (uint32)((uint32)__ROM_CODE_START + 0x400000UL),
        /*rasr*/ 0x070B002DUL   /* Size: 8MB, Type: Normal, Inner Cache Policy: Inner write-back, write and read allocate, Outer Cache Policy: Outer write-back. write and read allocate, Shareable: No, Privileged Access: Read-Only, Unprivileged Access: Read-Only */
    );
        #endif
        #else
	SetMPURegion(
